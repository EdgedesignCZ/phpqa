...
then
    ...
    if [ ! -z "$requireMode" ]; then
        ...
        composer require symfony/filesystem:~2 symfony/process:~2 symfony/finder:~2 jakub-onderka/php-parallel-lint jakub-onderka/php-console-highlighter phpstan/phpstan:~0.8.0 friendsofphp/php-cs-fixer:~2.2 vimeo/psalm sensiolabs/security-checker $requireMode
    else
        # symfony 3
